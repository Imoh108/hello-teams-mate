            ...
            <Dialog open={openCreate} onOpenChange={setOpenCreate}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>Pick categories, choose how many rounds and questions, and we'll assemble the quiz from your approved question bank.</DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  <DialogFooter>
                    <Button onClick={onBuild} disabled={building || selectedCats.size === 0 || requestedTotal > poolAvailable}>
